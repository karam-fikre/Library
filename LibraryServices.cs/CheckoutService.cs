...
namespace LibraryServices.cs
{
    public class CheckoutService : ICheckout
    {
        ...
        public void MarkFound(int assetId)
        {
            ...
            CloseExistingCheckoutsHistory(assetId);
        ...
        private void CloseExistingCheckoutsHistory(int assetId)
        {
        ...
        public void CheckOutItem(int assetId, int libraryCardId)
        {
            ...
            {
                return;
                //Add logic where to handle feedback to the user
            }
            ...
            var checkout = new Checkout {
                ...
                Since =now,
                Üntil = GetDefaultCheckoutTime(now)
            };
